...
Date: ${datesRange[dayNumber - 1].getDate()}-${new Date(endDateWithinWeek).getMonth() + 1
                        }-${new Date(endDateWithinWeek).getFullYear()}
Time: ${SlotInTime % 12} ${SlotInTime > 12 ? "pm" : "am"} - ${SlotOutTime % 12
